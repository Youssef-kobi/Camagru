        ...
        <div id= "tab_1" class="card card-body bg-light tab-pane active">
            ...
            <div class="row d-flex">
                <div class="main ml-auto">
                    ...
                    <br>
                    <div id= "stickers" class="card card-body bg-dark sticker_css ">
                        <input type="radio" name="sticker_radio" id="sticker_0" />
                        <label for="sticker_0"><img id="sticker_0" src="<?php echo URLROOT;?>/public/img/stickers/boss.png" /></label>
                        <input type="radio" name="sticker_radio" id="sticker_1" />
                        <label for="sticker_1"><img id="sticker_1" src="<?php echo URLROOT;?>/public/img/stickers/inkonnu.png" /></label>
                        <input type="radio" name="sticker_radio" id="sticker_2" />
                        <label for="sticker_2"><img id="sticker_2" src="<?php echo URLROOT;?>/public/img/stickers/GoOutside.png" /></label>
                        <input type="radio" name="sticker_radio" id="sticker_3" />
                        <label for="sticker_3"><img id="sticker_3" src="<?php echo URLROOT;?>/public/img/stickers/rick&morty.png" /></label>
                            
                    </div>
                </div>

                <div id="sidebar" class="img-fluid card card-body bg-dark">
         ...
         <div id= "tab_2" class="card card-body bg-light tab-pane ">
            ...
            <div class="row d-flex">
                <div class="main ml-auto">
                    ...
                    <canvas id="canvas" class="d-none"></canvas>
                    <br>
                    <div id= "stickers_uploads" class="card card-body bg-dark sticker_css ">
